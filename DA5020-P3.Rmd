...
dtrain.x <- data_train %>% select(-predictor_var)
dtrain.y <- data_train %>% select(predictor_var) 
dtest.x <- data_test %>% select(-predictor_var) 
dtest.y <- data_test %>% select(predictor_var)
...
knn.predict(data_train, data_test,'tip_amount',5)
